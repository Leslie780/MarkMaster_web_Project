...
switch ($method) {
    ...
    case 'POST':
        ...
        $required = ['course_code', 'course_name', 'lecturer_id', 'academic_year', 'semester', 'credit_hours', 'status'];
        ...
        try {
            $stmt = $pdo->prepare("INSERT INTO courses (course_code, course_name, lecturer_id, academic_year, semester, credit_hours, description, status, created_at, updated_at) VALUES (?, ?, ?, ?, ?, ?, ?, ?, NOW(), NOW())");
            $stmt->execute([
                $course_code, $course_name, $lecturer_id, $academic_year, $semester, $credit_hours, $description, $status
            ]);
